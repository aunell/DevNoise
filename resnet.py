...
models= ['/om/user/aunell/data/AntiBiomimetic', '/om/user/aunell/data/Biomimetic', '/om/user/aunell/data/noise',
        '/om/user/aunell/data/grayblur', '/om/user/aunell/data/baseline']
for path in models:
