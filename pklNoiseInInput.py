...
for l in range(1):
    ...
    for m in training:
      ...
      if m==0:
        ...
        name='noisemodel'
      path='/om/user/aunell/activationData/noiseInput/'+name
      model.save(path)
      ...
      path='/om/user/aunell/activationData/noiseInput/'+modelName
      model.save(path)
...
testImages= [test_imagesBlurAndGray, test_imagesNoise]
noise=[0]
paths=['/om/user/aunell/activationData/noiseInput/clearmodel','/om/user/aunell/activationData/noiseInput/noisemodel', 
       '/om/user/aunell/activationData/noiseInput/CleartoNoisebio','/om/user/aunell/activationData/noiseInput/NoisetoClearbio']
for path in paths:
    for i in range(len(testImages)):
        ...
        activations = activation_model.predict(testImages[i])
        print(activations[4].shape)
        print(activations[3].shape)
        #SAVE ACTIVATION HERE
        title= path[42:]
        if i!=0:
            path2='/om/user/aunell/activationData/noiseInput/pickledFiles/NoisyTest/'+str(title)+'.pkl'
        else:
            path2='/om/user/aunell/activationData/noiseInput/pickledFiles/ClearTest/'+str(title)+'.pkl'
