...
#       path='/om/user/aunell/data/Biomimeticloc1a'
#       model.save(path)
#       callbacks.pop()
...
# grayblur color
      ...
      print('ending biomodel')
      path='/om/user/aunell/data/grayblurColor'
      model.save(path)
      #callbacks.pop()
  else:
#     #noise
...
#       print('ending biomodel')
#       path='/om/user/aunell/data/antiBioloc1a'
#       model.save(path)
#       callbacks.pop()
...
paths= ['/om/user/aunell/data/Biomimeticloc1a', '/om/user/aunell/data/noiseloc1a',
...
# Normalize pixel values to be between 0 and 1
            train_images, test_imagesNoise = train_images / 255.0, test_imagesNoise / 255.0
            
            test_imagesNoise=test_imagesNoise[2000:]
            test_labels=test_labels[2000:]
...
plt.title('Noise Robustness ResNet50-- Best Results With or Without Noise in Test')
